...
class Adminextrainfo extends Module
{
    protected $config_form = false;

    public function __construct()
    {
        $this->name = 'adminextrainfo';
        ...
        $this->displayName = $this->l('Admin Extra Info');
        $this->description = $this->l('Extra Info in Admin Lists and Forms');
    ...
    {
        Configuration::deleteByName('ADMINEXTRAINFO_LIVE_MODE');
    ...
    public function getContent()
    {
         ...
         */
        if (((bool)Tools::isSubmit('submitAdminextrainfoModule')) == true) {
            $this->postProcess();
        }
    ...
    protected function renderForm()
    {
        ...
        $helper->submit_action = 'submitAdminextrainfoModule';
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'name' => 'ADMINEXTRAINFO_ACCOUNT_EMAIL',
                        'label' => $this->l('Email'),
                    ),
                    array(
                        'type' => 'password',
                        'name' => 'ADMINEXTRAINFO_ACCOUNT_PASSWORD',
    ...
    {
        return array(
            'ADMINEXTRAINFO_LIVE_MODE' => Configuration::get('ADMINEXTRAINFO_LIVE_MODE', true),
            'ADMINEXTRAINFO_ACCOUNT_EMAIL' => Configuration::get('ADMINEXTRAINFO_ACCOUNT_EMAIL', 'contact@prestashop.com'),
            'ADMINEXTRAINFO_ACCOUNT_PASSWORD' => Configuration::get('ADMINEXTRAINFO_ACCOUNT_PASSWORD', null),
        );
    }
